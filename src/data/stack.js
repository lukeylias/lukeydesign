export default {
  ...
  defaultVisible: 10,
  items: [
    { slug: 'figma', headline: 'Figma', body: 'Still the best tool for collaborative UI work. Auto-layout and components make it feel like writing CSS visually.', image: 'https://placehold.co/250x250' },
    ...
    { slug: 'linear', headline: 'Linear', body: 'Fast, keyboard-driven, and opinionated in the right ways. Makes project management feel less like project management.', image: 'https://placehold.co/250x250' },
    ...
    { slug: 'raycast', headline: 'Raycast', body: 'Spotlight replacement with extensions, snippets, and window management. The clipboard history alone is worth it.', image: 'https://placehold.co/250x250' },
    ...
    { slug: 'cloudflare', headline: 'Cloudflare', body: 'DNS, CDN, and Workers in one place. The free tier is generous enough for most personal projects.', image: 'https://placehold.co/250x250' },
